...
class LocalMemberSearchAdapterTest {

    private val localMemberRepository: MariaDBLocalMemberRepository = mockk()
    private val memberSearchAdapter = LocalMemberSearchAdapter(localMemberRepository)
    ...
    fun existsLocalMemberBylocalIdSuccess() {
         ...
         * when, then
         */
        assertEquals(memberSearchAdapter.existsByLocalId(ID(localId)), true)
    }
    ...
    fun existsLocalMemberBylocalIdFailure() {
         ...
         * then
         */
        assertEquals(memberSearchAdapter.existsByLocalId(ID(localId)), false)
    }
    ...
    fun findLocalMemberBylocalIdSuccess() {
        ...
        val localMember = memberSearchAdapter.findByLocalId(ID(localId))
    ...
    fun findLocalMemberBylocalIdFail() {
         ...
         * then
         */
        assertThrows<ToothException> { memberSearchAdapter.findByLocalId(ID(localId)) }
    }
}
